  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Bienvenido a nuestra tienda virtual de ropa. Al acceder y utilizar este sitio web, aceptas cumplir con los siguientes términos y condiciones de uso.</p>
        <br>
        <b>Información del Usuario</b>
        <ul>
        	<li>Al registrarte en nuestro sitio, proporcionas información precisa y completa sobre ti mismo.</li>
        	<li>Eres responsable de mantener la confidencialidad de tu cuenta y contraseña.</li>
        </ul>
        <br>
        <b>Precios y pagos</b>
        <ul>
        	<li>Los precios de los productos se muestran en la moneda local y pueden estar sujetos a impuestos adicionales.</li>
        	<li>El cliente es responsable de cualquier cargo adicional asociado con el método de pago seleccionado.</li>
        </ul>
      </div>
					...
					?>
						<div>
							...
							<div class="bor8 bg0 m-b-22">
								<input id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Ciudad / Cantón">
							</div>
						</div>
					<?php }else{ ?>
