...
<div class="container">
	...
	<h1 class="alerta text-center">No hay productos en el carrito</h1>
	<div class="container-img-carrito">
		<img class="img-carrito" src="<?= base_url() ?>/Assets/tienda/images/anadir-al-carrito.png">
	</div>
	<h3 class="text-center text-agregar">Agrega productos a tu compra</h3 class="text-center">
	<h5 class="text-center padding-bot"><a href="<?= base_url() ?>/tienda" class="text-ver">Ver productos</a></h5>
