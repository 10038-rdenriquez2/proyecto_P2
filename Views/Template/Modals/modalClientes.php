            ...
            <form id="formCliente" name="formCliente" class="form-horizontal">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="txtIdentificacion" name="txtIdentificacion" maxlength="10" minlength="10" required="">
                </div>
                <div class="form-group col-md-4">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control valid validNumber" id="txtTelefono" name="txtTelefono" required="" maxlength="10" minlength="7" onkeypress="return controlTag(event);">
                </div>
                <div class="form-group col-md-4">
